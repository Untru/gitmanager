...
// Структурированные данные по задаче.
// 
// Параметры:
//  НомерЗадачи - Произвольный - Номер задачи
//  ТаскТрекер - Неопределено - Таск трекер
// 
// Возвращаемое значение:
//  Неопределено, Структура - Структурированные данные по задаче:
// * Наименование - Строка - 
// * Описание - Строка - 
// * СсылкаBitrix - Строка - 
...
// Вынесены методы в служебный, т.к. неожиданно появилась стратегия таск трекеров
// todo: Пересмотреть методы и поставить на поддержку в Программный интерфейс
...
Процедура ЗагрузитьЗадачиПоРеестру() Экспорт
	...
	Для Каждого Элемент Из НомераЗадач Цикл
		Попытка
			...
			ДанныеЗаполнения = РаботаСBitrix.СтруктурированныеДанныеПоЗадаче(Элемент);
