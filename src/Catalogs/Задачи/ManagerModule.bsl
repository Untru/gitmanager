...
Функция НовыйДанныеЗадачи() Экспорт
	
	ДанныеЗаполнения = Новый Структура();

	ДанныеЗаполнения.Вставить("Наименование");
	ДанныеЗаполнения.Вставить("ПодробноеОписание");	
	...
	ДанныеЗаполнения.Вставить("КрайнийСрок");
	ДанныеЗаполнения.Вставить("ПлановоеВремя");
	ДанныеЗаполнения.Вставить("ЗатраченноеВремя");
	ДанныеЗаполнения.Вставить("ДатаСоздания");
	ДанныеЗаполнения.Вставить("НомерЗадачи");
	ДанныеЗаполнения.Вставить("ИмяВетки");
	ДанныеЗаполнения.Вставить("НомерЗадачиИтилиум");	
	ДанныеЗаполнения.Вставить("ПлановаяДатаРелиза");
	ДанныеЗаполнения.Вставить("ТипЗадачи");
	ДанныеЗаполнения.Вставить("Владелец");
	ДанныеЗаполнения.Вставить("СсылкаBitrix"); 
	ДанныеЗаполнения.Вставить("ДатаСозданияБазовойЗадачи");
	ДанныеЗаполнения.Вставить("ТипБазовойЗадачи");
...
Функция РеквизитыЗадачи(Задача) Экспорт
	...
	Если ЗначениеЗаполнено(РеквизитыЗадачи.ПрефиксВетки) Тогда
		ПараметрыЗадачи.Вставить("ИмяВетки", СтрШаблон("%1/%2", РеквизитыЗадачи.ПрефиксВетки, РеквизитыЗадачи.ИмяВетки));
	Иначе
		ПараметрыЗадачи.Вставить("ИмяВетки", РеквизитыЗадачи.ИмяВетки);
	КонецЕсли;
...
Функция НеЗакрытыеЗадачи() Экспорт
	...
	Запрос.Текст = 
		...
		|	Задачи.Владелец.ТаскТрекер.ТипТаскТрекера КАК ТипТаскТрекера
		|ИЗ
		|	Справочник.Задачи КАК Задачи
		|ГДЕ
